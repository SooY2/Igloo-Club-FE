...
export const FACEDEPICTION = [
  ...
  { value: 'LONG_ARMS', label: '팔길이가 길어요' },
  { value: 'LONG_LEGS', label: '다리가 길어요' },
  { value: 'SOFT_FIGURE', label: '체형이 부드럽게 보어요' },
  { value: 'BRIGHT_EYES', label: '눈이 크고 맑아요' },
  { value: 'EYE_SMILE', label: '눈웃음이 이뻐요' },
  ...
  { value: 'ROUND_FACE', label: '얼교형이 둥근 편이에요' },
  { value: 'BRIGHT_SKIN', label: '피부가 밝아요' },
  { value: 'CLEAN_TEETH', label: '이가 깔끔해요' },
...
export const PERSONALITYDEPICTION = [
  ...
  { value: 'GOOD_AT_EXPRESSING_FEELINGS', label: '감정 표현을 잘해요' },
];
